...
import { BookEntitiesComponent } from './book-entities/book-entities.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      { path: 'book-entities', component: BookEntitiesComponent },
      { path: 'book-history', component: BookHistoryComponent },
      { path: 'add-book/:Id', component: AddBookComponent }
    ])
  ],

  providers: [HistoryService, BookEntitiesService],
